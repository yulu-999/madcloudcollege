            ...
            axiosRequest(
                ...
                layui.each(res.data.data, function(index, item){
                    ...
                    let htmlInfo = "<div class=\"col\">\n" +
                        ...
                        "                    <li class=\"list-group-item\"><span class=\"my-title\" > 创建时间 :</span> <span class=\"my-con\">  <span class=\"layui-badge layui-badge-rim\">"+item.time+"</span></span></li>\n" +
                    ...
                    axiosRequest(
                        ...
                        layui.each(res.data.data, function(index, item){
                            ...
                            let htmlInfo = "<div class=\"col\">\n" +
                                ...
                                "                </ul>\n" +
                                "                <div class=\"card-body\">\n" +
                                "                    <button type=\"button\" onclick='' class=\"btn  layui-bg-green\">加入课程</button>\n" +
